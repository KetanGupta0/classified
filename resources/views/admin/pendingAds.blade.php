...
<script>
    ...
    $(document).ready(function() {
        ...
        refreshPendingAdsList();

        function refreshPendingAdsList() {
            $.ajax({
                url: "{{ url('admin/fetchPendingAds') }}",
                type: "POST",
                async: false,
        ...
        // After click on approve, refresh all pending list again
        ...
        // After click on reject, refresh all pending list again
