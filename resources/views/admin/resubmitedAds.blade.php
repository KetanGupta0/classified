    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Resubmitted Ads</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        refreshResubmitedAdsList();

        function refreshResubmitedAdsList() {
            $.ajax({
                url: "{{ url('admin/fetchResubmittedAdd') }}",
                type: "POST",
                async: false,
